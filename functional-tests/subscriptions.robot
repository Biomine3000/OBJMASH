...
Everything But Events
    [Tags]    server    rules
    Subscribe                     *, !@*, @routing/subscribe/reply
...
Texts Not Having Hasselhoff Nature And Events With Hasselhoff Nature
    ...
    ${hoff_natures}=              Parse Subscriptions         hasselhoff
...
Subscribe
    [Arguments]          ${rules_str}
    ${rules}=    Parse Subscriptions    ${rules_str}
    Subscribe With Rules        ${rules}